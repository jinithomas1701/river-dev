...
import './CfoApproveDialog.scss';
import { Util } from '../../../../Util/util';

const classes = Util.overrideCommonDialogClasses();

class CfoApproveDialog extends Component {
    constructor(props) {
        super(props);
        this.state = {
            comment: ""
    ...
    render() {
        return (
            <Dialog className="cfo-approve-dialog-wrapper" classes={classes} open={this.props.isDialogOpen} size="md" onRequestClose={this.handleCancel}>
...
export default CfoApproveDialog;