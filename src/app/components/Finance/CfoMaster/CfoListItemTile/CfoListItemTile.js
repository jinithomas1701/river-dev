...
import './CfoListItemTile.scss';

class CfoListItemTile extends Component {
    ...
    render(){
        ...
        return(
            <div className="cfo-list-item-tile-wrapper" onClick={this.handleOnClick}>
...
export default CfoListItemTile;