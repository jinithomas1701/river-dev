...
import './CfoListItemDockDetails.scss';
import { riverToast } from '../../../Common/Toast/Toast';


class CfoListItemDockDetails extends Component {
    ...
    render() {
        ...
        return (
            <section className="cfo-list-item-dock-details-wrapper">
    ...
    getHeaderToolsTemplate(props) {
        let showApproveBtn, showRejectBtn, showArchiveBtn;
...
export default CfoListItemDockDetails;