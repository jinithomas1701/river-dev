...
import './FinanceTeamRejectDialog.scss';
import { Util } from '../../../../Util/util';

const classes = Util.overrideCommonDialogClasses();

class FinanceTeamRejectDialog extends Component {
    constructor(props) {
        super(props);
        this.state = {
            comment: ""
    ...
    render() {
        return (
            <Dialog className="reject-transaction-dialog-wrapper" classes={classes} open={this.props.isDialogOpen} size="md" onRequestClose={this.handleCancel}>
...
export default FinanceTeamRejectDialog;