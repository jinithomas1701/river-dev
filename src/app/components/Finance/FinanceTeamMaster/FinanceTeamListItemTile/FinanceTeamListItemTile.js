...
import './FinanceTeamListItemTile.scss';

class FinanceTeamListItemTile extends Component {
    ...
    render(){
        const subTitles = ['Ref#:','Type:','Created On:','Escalation In:'];
        ...
        return(
            <div className="finance-team-list-item-tile-wrapper" onClick={this.handleOnClick}>
                <div className="col-xs-1 img-wrapper">
                    <UserAvatar src={this.props.club.avatar} name={this.props.club.name} />
                </div>
                <div className="col-lg-10 item-details-wrapper">
                    ...
                    <div className="sub-details">
                        <div className="row">
                            ...
                            <dl className="col-lg-3 label-term-group">
                                <dt>{subTitles[3]}</dt>
                                <dd>{moment.unix(this.props.reminderDate/1000).format("DD MMM YYYY")}</dd>
                            </dl>
                        </div>     
                    </div>
                </div>
...
export default FinanceTeamListItemTile;