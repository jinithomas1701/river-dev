                                ...
                                <div className="col-md-4" style={{ "borderRight": "1px solid rgb(238, 255, 238)" }}>
                                    <div className="row">
                                        ...
                                        {(this.props.voice.voiceDetail.voiceLevel == "COUNCIL" && this.props.voice.voiceDetail.why == "COUNCIL_MEMBER" && this.props.voice.voiceDetail.actionStatus.status != "ACCEPTED") &&
                                            <div className="col-md-12" style={{ marginBottom: '0.5rem', marginTop: '0.2rem' }}>
                                        ...
                                        <div className="status-container" >
                                            ...
                                            <span className="type-value">{this.props.voice.voiceDetail ? this.props.voice.voiceDetail.actionStatus.status : "IN PROGRESS"}</span>
                                        </div>
                                        <div className="status-container" >
                                            ...
                                            <span className="type-value">
                                                {this.props.voice.voiceDetail.includePresident ?
                                                    ...
                                                    :
                                                    <strong style={{ color: "#947CB0" }}>NOT INCLUDED <small>DIRECT VOICE TO COUNCIL</small></strong>
                                                }
                                            </span>
                                        ...
                                        <div className="status-container" >
                                            ...
                                            <span className="type-value">{this.props.voice.voiceDetail ? this.props.voice.voiceDetail.voiceCouncils.name : "---"}</span>
                                        </div>
                                        ...
                                        <div className="status-container" >
                                            ...
                                            <span className="type-value">{Util.getDateStringFromTimestamp(this.props.voice.voiceDetail.createdOn)}</span>
                                        </div>
