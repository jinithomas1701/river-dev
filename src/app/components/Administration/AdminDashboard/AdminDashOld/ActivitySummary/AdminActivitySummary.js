...
export default class AdminAdminActivitySummary extends Component{
                ...
                <div className="filter-head">
                    ...
                    <div className="cols-3">
                        ...
                        <SelectBox 
                            ...
                            selectArray={this.props.clubNameList}
                            onSelect={this.handleActivityReportFilter()}
                            />
                    </div>
                </div>
                <div className="filter-results">
                    {this.getAdminActivitySummaryTemplate(this.props.adminActivitySummary)}
                </div>
                {
                    (this.props.adminActivitySummaryDetailsList.length > 0) && (
                        <div className="summary-details">
                            {this.getAdminActivitySummaryDetailsTemplate(this.props.adminActivitySummaryDetailsList)}
                        </div>
                    )
                }
            </article>
                    ...
                    adminActivitySummaryDetailsList.map(summary => {
                        return (<div className="summary-row">
                                ...
                                <div className="info">
                                    ...
                                    <div className="cols-1">{summary.status}</div>
    ...
    handleActivityReportFilterDay = () => (value) => {
        ...
        this.props.loadAdminActivitySummary(this.state.filterActivityReport, value);
    }
    ...
    handleActivityReportFilter = () => (value) => {
        ...
        this.props.loadAdminActivitySummary(value, this.state.filterActivityDay);
    }
    ...
    handleChartSelect = (chartWrapper) => {
        ...
        this.props.loadAdminActivitySummaryDetails(formattedDate, status, 10);
    }

    loadActivitySummaryDetails = (date, status, count, page = 0) => {
        AdminDashboardService.getAdminActivitySummaryDetails(date, status, count, page)
    ...
    loadActivitySummary = (searchParams, interval = 10) => {
        AdminDashboardService.getAdminActivitySummary(searchParams, interval)
