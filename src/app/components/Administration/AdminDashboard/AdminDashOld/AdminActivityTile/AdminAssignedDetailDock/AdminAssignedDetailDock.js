...
import './AdminAssignedDetailDock.scss';
...
export default class AdminAssignedDetailDock extends Component {
    state = {
        ...
        return (
            <div className="dashboard-assigned-detail-dock-container">
                ...
                <div className="activity-primary-details">
                    ...
                    <div className="view-ppoint-wrapper">
                        <div className="link" onClick={() => this.props.onViewPoints()}>
                            View points
                ...
                <div className="activity-discussion">
                    <Discussion 
                        ...
                        noSubmit={privileges.indexOf(VIEW_ADMIN_DASHBOARD) < 0}
                        height="45rem"
