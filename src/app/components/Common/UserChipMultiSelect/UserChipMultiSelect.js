...
// css
import './UserChipMultiSelect.scss';
import { ApiUrlConstant } from '../../../Util/apiUrl.constant';

export class UserChipMultiSelect extends React.Component {
    state = {
        searchKey: "",
    ...
    render() {
        ...
        const innerStyle = this.props.innerStyle ? this.props.innerStyle : (this.props.customStyle ? this.props.customStyle : {});
        return (
            <div className="userMultiChipSelect">
                <div className={("search-box-container ") + (this.props.searchBoxClass || "")}>
                    ...
                    {(this.props.resultChips.length > 0) &&
                        <div className="search-results-container" style={innerStyle}>
                            {searchItems}
                        </div>
                    }
