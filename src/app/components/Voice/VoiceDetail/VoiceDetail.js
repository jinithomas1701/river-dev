...
class VoiceDetail extends React.Component {
    ...
    render() {
        ...
        const voiceType = this.props.voiceDetail.voiceTypesList.map((itm, indx) => {
            ...
            if (itm.value == this.props.voiceDetail.voiceTypesList.value) {
                            ...
                            <div className="row ">
                                <div className="col-md-4" style={{ borderRight: "1px solid #efef" }}>
                                    <div className="row">
                                        ...
                                        {!this.state.editMode &&
                                            <div className="status-container" title="Voice Type">
                                                <span className="type-key">TYPE</span>
                                                <span className="type-value">{voiceType}</span>
                                            </div>
                                        }
...

                                        {
                                            ...
                                            <div className="status-container" title="VOICE STATUS">
                                                <span className="type-key">STATUS</span>
                                                <span className="type-value">{this.props.voiceDetail.voiceDetails.actionStatus.status}</span>
                                            </div>
                                        }
                                        ...
                                        {this.voiceId && <div className="status-container" title="Club President">
                                            <span className="type-key">CLUB PRESIDENT</span>
                                            <span className="type-value">
                                                {this.voiceId && this.props.voiceDetail.voiceDetailFields.includePresident &&
                                                    <strong style={{ color: "#f03434" }}> INCLUDED<small> in this VOICE</small></strong>
                                                }

                                                {this.voiceId && !this.props.voiceDetail.voiceDetailFields.includePresident &&
                                                    <strong style={{ color: "#947CB0" }}>NOT INCLUDED <small> - DIRECT VOICE</small></strong>
                                                }
                                            </span>
                                        </div>}
                                        ...
                                        {
                                            (this.props.match.params.voiceId) &&
                                            <div className="status-container" title="Panel">
                                                <span className="type-key">PANEL</span>
                                                <span className="type-value">{this.props.voiceDetail.voiceDetailFields.voiceCouncil.name}</span>
                                            </div>
                                        }
                                        ...
                                        {this.props.voiceDetail.voiceDetails.actionStatus.status === "REFINED" &&
                                            <div className="status-container" title="Message From Admin">
                                                <span className="type-key">Message From Admin</span>
                                                <span className="type-value">{this.props.voiceDetail.voiceDetails.actionStatus.message}</span>
                                            </div>
                                        }
                                        {this.props.voiceDetail.voiceDetails.voiceTags.length > 0 &&
                                            <div className="status-container" title="Tagged Users">
                                                <span className="type-key">Tagged Users</span>
                                                <span className="type-value">{taggedUsers}</span>
                                            </div>
                                        }
                                        {this.voiceId &&
                                            <div className="status-container" title="Raised By">
                                                <span className="type-key">Raised By</span>
                                                <span className="type-value">
                                                    <CustomAvatar
                                        ...
                                        {this.voiceId &&
                                            <div className="status-container" title="RAISED ON">
                                                <span className="type-key">RAISED ON</span>
                                                <span className="type-value">{Util.getDateStringFromTimestamp(this.props.voiceDetail.voiceDetails.createdOn)} </span>
                                            </div>
                                        }
