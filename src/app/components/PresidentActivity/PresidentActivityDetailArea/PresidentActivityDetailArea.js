...
// css
import "./PresidentActivityDetailArea.scss";
...
class PresidentActivityDetailArea extends Component {
    ...
    constructor(props) {
        ...
        this.handleForceStopActivity = this.handleForceStopActivity.bind(this);
    ...
    render() {
        ...
        const editableActivity = (activity && activity.status === ACTIVITY_STATUS_COMPLETED);
        const { anchorEl } = this.state;

        return (
            <section className="president-activity-detail">
    ...
    getDockTemplate(activity, editableActivity) {
        ...
        return (
            <section className="president-activity-content">
                <ActivityHeaderInfo {...activity}
                    onKpiDetailsOpen={this.props.onKpiDetailsOpen}
                />
                {editableActivity ? this.getFormTemplate(activity) : this.getDisplayTemplate(activity)}
    ...
    getFormTemplate(activity) {
        ...
        return (
            <div className="president-activity-form">
    ...
    getDisplayTemplate(activity) {
        ...
        return (
            <div className="president-activity-display">
                <FieldHeader title="Assessments" />
    ...
    getActionsTemplate(activity, editableActivity) {
        ...
        const forceStopable = activity.forceStoppable;

        return (
            <div className="submit-wrapper">
                {
                    editableActivity && <LoadedButton title="Approve" className="btn-primary btn-submit" color="primary" onClick={this.handleApproveActivity} loading={loading}>Approve</LoadedButton>
                }
                {
                    editableActivity && <LoadedButton title="Reassign" className="btn-default btn-submit" color="default" onClick={this.handleResubmitActivity} loading={loading}>Reassign</LoadedButton>
                }
                {
                ...
                {
                    forceStopable && <LoadedButton title="Force Stop" className="btn-complimentary btn-forcestop" color="default" onClick={this.handleForceStopActivity} loading={loading}>Force Stop</LoadedButton>
                }
                {
                    editableActivity && <LoadedButton title="Reject" className="btn-complimentary btn-reject" color="default" onClick={this.handleRejectActivity} loading={loading}>Reject</LoadedButton>
                }
                {
    ...
    handleForceStopActivity() {
        this.props.onForceStop(this.props.selectedActivity);
    }
...
PresidentActivityDetailArea.defaultProps = {
    discussionList: []
};

PresidentActivityDetailArea.propTypes = {
...
export default PresidentActivityDetailArea;