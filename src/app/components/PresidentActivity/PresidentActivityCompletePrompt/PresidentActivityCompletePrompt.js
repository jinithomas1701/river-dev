...
// css
import "./PresidentActivityCompletePrompt.scss";

const RATING_TYPE_STAR = "S";
const RATING_TYPE_CATEGORY = "C";
const ACTIVITY_STATUS_ACTIVE = "A";

class PresidentActivityCompletePrompt extends Component {
    constructor(props) {
        super(props);
        this.state = {
            comment: ""
    ...
    getMainTemplate(activity) {
        ...
        return (
            <Dialog
                ...
                maxWidth="md"
                className="president-activitycomplete-wrapper"
            >
...
PresidentActivityCompletePrompt.propTypes = {
...
export default PresidentActivityCompletePrompt;