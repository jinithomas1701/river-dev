const PanelActivityReducer = (state ={
    assignedActivities: [],
    ...
    switch(action.type) {
        case "PANEL_ACTIVITY_ASSIGNED_ACTIVITIES_CHANGE":
            state = {
                ...state,
                assignedActivities: action.payload
            };
            break;
        case "PANEL_ACTIVITY_SELECTED_ACTIVITY_CHANGE":
            ...
            break;
        case "PANEL_ACTIVITY_SELECTED_ACTIVITY_RESET":
            state = {
                ...state,
                selectedActivityDetails: undefined
            };
            break;
        case "PANEL_ACTIVITY_POINTMATRIX_CHANGE":
            ...
            break;
        case "PANEL_ACTIVITY_MEMBER_POINT_CHANGE":
            ...
            break;
        case "PANEL_ACTIVITY_CLUB_POINT_CHANGE":
            ...
            break;
        case "PANEL_ACTIVITY_POINT_RESET":
            newActivity = {...state.selectedActivityDetails};
            ...
            break;
        case "PANEL_ACTIVITY_KPI_LIST_CHANGE":
            state = {
                ...state,
                kpiList: [...action.payload]
            };
            break;
        case "PANEL_ACTIVITY_KPI_DETAILS_CHANGE":
            state = {
                ...state,
                kpiDetails: action.payload
            };
            break;
        case "PANEL_ACTIVITY_STORE_DISCUSSION":
            state = {
                ...state,
...
export default PanelActivityReducer;