...
class ActivityDock extends Component {
    ...
    render() {
        ...
        return (
            <div className="activity-view-dock">
                ...
                {
                    this.props.role == 'ROLE_RIVER_COUNCIL' && this.state.isCouncilApprove ?
    ...
    postCommentTask(commentValue, activity) {
        if (commentValue.trim()) {
            ...
            CommonDashboardService.postComment(commentRequest)
                .then(data => {
    ...
    loadMoreComments() {
        if (this.props.activity && this.props.activity.commentId) {
            ...
            CommonDashboardService.loadMoreComments(this.props.activity.commentId, this.commentSkipCount, this.commentSize)
                .then(comments => {
    ...
    assignActivity(activityId, assignees) {
        ...
        .then((data) => {
            ...
            this.props.onAssignUsers(data, this.props.index, "dock");
            this.setState({
                ...this.state,
                assigneeSearchResult: [],
                selectedAssigneesList: [],
    ...
    onCouncilAcceptActivity() {
        if (confirm("Do you want to approve these memebers ?")) {
            ...
            CommonDashboardService.councilApproveActivity(this.props.activity.id, approveRequest)
                .then((data) => {
                    this.props.onAssignUsers(data, this.props.index, "dock");
                    this.setState({
                        isCouncilApprove: false
