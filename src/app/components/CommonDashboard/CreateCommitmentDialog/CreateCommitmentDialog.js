...
import {fieldChange,
        clearCommitmentsFields} from '../CommonDashboard.actions';
...
const mapStateToProps = (state) => {
    return {
        clubDash: state.CommonDashboardReducer
    }
};
...
class CreateCommitmentDialog extends React.Component {
    ...
    onSubmit() {
        ...
        CommonDashboardService.createCommitment(this.processCommitmentRequest())
        .then(data => {
